...
* **Project Description:** [View on Google Drive](https://drive.google.com/file/d/1HPf17hvqI6icNTjRPkPuydkV1ub_lxO5/view?usp=sharing)
...
* Run the feature pipeline for past dates to generate training data.
* Create a comprehensive dataset for model training and evaluation.
...
* Compute real-time predictions for the next 3 days.
* Display an interactive dashboard with Streamlit/Gradio and Flask/FastAPI.
...
* [Resource Link](https://drive.google.com/file/d/1HPf17hvqI6icNTjRPkPuydkV1ub_lxO5/view?usp=sharing)